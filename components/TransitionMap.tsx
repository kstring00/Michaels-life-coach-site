...
export function TransitionMap(){
  return <section className="section transition-map"><div className="container">
    <div className="section-head"><div><div className="eyebrow" style={{color:"#82baff"}}>Is this where you are?</div><h2 className="display">A life can change before you know what to call it.</h2></div><p className="body-lg">GrowthGains is built for transitions that rearrange your roles, your direction or the way you understand yourself.</p></div>
