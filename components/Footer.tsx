      ...
      <div className="container">
        <div className="footer-top">
          ...
          <div className="footer-nav">
            ...
            <Link href="/approach">Approach</Link><Link href="/coaching-vs-counseling">Coaching vs. counseling</Link>
            <Link href="/stories">Client stories</Link><Link href="/consultation">Free consultation</Link>
